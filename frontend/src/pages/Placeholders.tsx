...
export function EmployeePage() {
 const [profile, setProfile] = useState<EmployeeProfile>(); const [employeeId,setEmployeeId]=useState('E0028'); const [employees,setEmployees]=useState<any[]>([]); const reloadProfile = () => { void careerQuestApi.employee(employeeId).then(setProfile) }; useEffect(() => { reloadProfile() }, [employeeId]); useEffect(()=>{void careerQuestApi.employees().then(setEmployees)},[])
